...
class Field(models.Field):
    ...
    def create_column(self):
        ...
        self.column = Column(
            self.name, self.sa_column_type(),
            *self.sa_column_args(), **kwargs
        )
        return self.column
